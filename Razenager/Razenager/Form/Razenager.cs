...
namespace Razenager
{
    public partial class Razenager : Form
    {
        ...
        private readonly string API_UserHistoricalNotesDefault = ConfigurationManager.AppSettings["userHistoricalNotes-Default"];
        private readonly string API_UserCoursesDefault = ConfigurationManager.AppSettings["userCourses-Default"];
        private readonly string API_UserCoursesNotesDefault = ConfigurationManager.AppSettings["userCoursesNotes-Default"];

        private string API_UserInfo = ConfigurationManager.AppSettings["userInfo"];
        private string API_UserHistoricalNotes = ConfigurationManager.AppSettings["userHistoricalNotes"];
        private string API_UserCourses = ConfigurationManager.AppSettings["userCourses"];
        private string API_UserCoursesNotes = ConfigurationManager.AppSettings["userCoursesNotes"];

        public Razenager()
        {
            InitializeComponent();
            this.BackColor = Color.FromArgb(20, 22, 24);
            CB_Login_Role.Text = "student";
            TB_Login_Pass.PasswordChar = '*';
            TB_Config_UserInfo.Text = API_UserInfo;
            TB_Config_UserHistoricalNotes.Text = API_UserHistoricalNotes;
            TB_Config_UserCourses.Text = API_UserCourses;
            TB_Config_UserCoursesNotes.Text = API_UserCoursesNotes;
        ...
        private void BTN_Info_GetInfoToken_Click(object sender, EventArgs e)
        {
            ...
            {
                ExtractData(RTB_Info_ContentToken.Text, new Uri(API_UserInfo), HttpMethod.Post, BTN_Info_GetInfoToken, RTB_Info_ContentResult, "GET INFO/NOTES");
                return;
            }

            ExtractData(RTB_Info_ContentToken.Text, new Uri(API_UserHistoricalNotes), HttpMethod.Post, BTN_Info_GetInfoToken, RTB_Info_ContentResult, "GET INFO/NOTES");
        }
        ...
        private void BTN_Courses_GetCoursesNotesSubToken_Click(object sender, EventArgs e)
        {
            if (CheckData(RTB_Courses_ContentToken) || CheckData(RTB_CoursesNotes_ContentSubToken)) return;

            ExtractData(RTB_Courses_ContentToken.Text,RTB_CoursesNotes_ContentSubToken.Text, new Uri(API_UserCoursesNotes),HttpMethod.Post, BTN_Courses_GetCoursesToken, BTN_Courses_GetCoursesNotesSubToken,RTB_Courses_ContentResult, "GET COURSES DATA", "GET COURSE NOTE");
        }
        ...
        private void BTN_Config_Save_Click(object sender, EventArgs e)
        {
            ...
            string[] keys = { "userInfo", "userHistoricalNotes" , "userCourses", "userCoursesNotes" };
            string[] values = { TB_Config_UserInfo.Text , TB_Config_UserHistoricalNotes.Text , TB_Config_UserCourses.Text , TB_Config_UserCoursesNotes.Text };
            
            ManageConfig(keys,values);
            API_UserInfo = TB_Config_UserInfo.Text;
            API_UserHistoricalNotes = TB_Config_UserHistoricalNotes.Text;
            API_UserCourses = TB_Config_UserCourses.Text;
            API_UserCoursesNotes = TB_Config_UserCoursesNotes.Text;
        ...
        {
            errorProviderData.Clear();
            if (API_UserInfoDefault == TB_Config_UserInfo.Text && API_UserHistoricalNotesDefault == TB_Config_UserHistoricalNotes.Text  && API_UserCoursesDefault == TB_Config_UserCourses.Text && API_UserCoursesNotesDefault == TB_Config_UserCoursesNotes.Text) return;

            string[] keys = { "userInfo", "userHistoricalNotes", "userCourses", "userCoursesNotes" };
            string[] values = { API_UserInfoDefault , API_UserHistoricalNotesDefault , API_UserCoursesDefault , API_UserCoursesNotesDefault };

            ManageConfig(keys,values);
            TB_Config_UserInfo.Text = API_UserInfoDefault;
            TB_Config_UserHistoricalNotes.Text = API_UserHistoricalNotesDefault;
            TB_Config_UserCourses.Text = API_UserCoursesDefault;
            TB_Config_UserCoursesNotes.Text = API_UserCoursesNotesDefault;

            API_UserInfo = API_UserInfoDefault;
            API_UserHistoricalNotes = API_UserHistoricalNotesDefault;
            API_UserCourses = API_UserCoursesDefault;
            API_UserCoursesNotes = API_UserCoursesNotesDefault;
        ...
        private bool CheckConfig(string check_url = "https://mimundo.upn.edu.pe/api", string msg = "Enter a valid URL!")
        {
            ...
            if (!TB_Config_UserHistoricalNotes.Text.StartsWith(check_url, StringComparison.OrdinalIgnoreCase))
            {
                valid = true;
                errorProviderData.SetError(TB_Config_UserHistoricalNotes, msg);
            }
            ...
            if (!TB_Config_UserCoursesNotes.Text.StartsWith(check_url, StringComparison.OrdinalIgnoreCase))
            {
                valid = true;
                errorProviderData.SetError(TB_Config_UserCoursesNotes, msg);
            }

            if (TB_Config_UserInfo.Text == API_UserInfo && TB_Config_UserCourses.Text == API_UserCourses && TB_Config_UserHistoricalNotes.Text == API_UserHistoricalNotes)
            {
                valid = true;
            }
