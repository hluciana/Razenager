...
namespace Razenager
{
    ...
    {
        private static string bin = ConfigurationManager.AppSettings["browser"];
        ...
        private void BTN_Scrap_Click(object sender, System.EventArgs e)
        {
            ...
            Task.Run(()=>
            {
                RN_Script.Chrome(TB_Mail.Text, TB_Pass.Text, TB_Browser.Text,RTB_Log,RTB_User);
        ...
        {
            if (CB_Type.SelectedIndex == 0) RTB_User.Text = RN_Script.dataPlain;
            else RTB_User.Text = RN_Script.dataJSON;
        }

        private void BTN_ClearData_Click(object sender, EventArgs e)
        {
            RTB_User.Clear();
            RN_Script.dataPlain = String.Empty;
            RN_Script.dataJSON = String.Empty;
        }
        ...
        private void BTN_DownloadData_Click(object sender, EventArgs e)
        {
            ...
            {
                saveFileDialogData.FileName = "razeData.txt";
                if (saveFileDialogData.ShowDialog() == DialogResult.OK)
                {
