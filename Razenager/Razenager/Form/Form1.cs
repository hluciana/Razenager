...
namespace Razenager
{
    public partial class Razenager : Form
    {
        ...
        private bool ErrorConfig()
        {
            ...
            if (!TB_Mail.Text.ToLower().StartsWith("n") || !TB_Mail.Text.EndsWith("@upn.pe") || TB_Mail.Text.Length != 16)
            {
                status = true;
        ...
        private void BTN_DownloadData_Click(object sender, EventArgs e)
        {
            ...
            {
                saveFileDialogData.FileName = $"raze{CB_Type.Text}.txt";
